  ...
  <main role="main" class="container" style="padding:60px 15px 0">
    <div>
      ...
      if (count($images) > 0) {
        ...
        // もしarray_chunkを使わなかったら、配列はこんな感じになる
        //
        // array(4) { [0]=> string(27) "20241124103127544336230.jpg"
        //            [1]=> string(27) "20241220181613564919233.jpg"
        //            [2]=> string(19) "GGPGz1ObsAEhmhR.jpg"
        //            [3]=> string(19) "GGPGzE6aQAEPfCW.jpg" }
        //
        var_dump($images);
        // 現在albumディレクトリにある画像の数を取得
        /*
    データはこんな感じでした
    array(4) {
  [0]=> array(4) {
    [0]=> string(27) "20241124103127544336230.jpg"
    [1]=> string(27) "20241220181613564919233.jpg"
    [2]=> string(19) "GGPGz1ObsAEhmhR.jpg"
    [3]=> string(19) "GGPGzE6aQAEPfCW.jpg"
  }
     */
        ...
        // GETでページ数が指定されていた場合
        // もしGETでページ数が指定されていて、かつ数値だったら
        if (isset($_GET['page']) && is_numeric($_GET['page'])) {// numericは数値かどうかを判定する関数.例えば、is_numeric('123')はtrueを返す
